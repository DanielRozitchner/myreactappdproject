const productos = [
    ...
    stock: true },
    {id: 8,
    foto: 'https://images.deliveryhero.io/image/pedidosya/products/7368e85d-b917-4932-ba50-0bd8cc185447.jpg?quality=90&width=461&webp=1' ,
    cake: 'Cake Bombon Oreo',
    categoria: 'cakes',
    detalle: 'Brownie con dulce de leche, crema chantilly y galletitas Oreo.',
    precio: 500,
    cantidad:1,
    stock: true }
];
